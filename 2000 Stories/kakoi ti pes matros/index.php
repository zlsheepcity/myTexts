...
<?
	...
	if (isset($_GET["quiz"])) {
		...
		$html = '<table width="600" bgcolor="#992222" color="#000000" border="0" cellpadding="4" cellspacing="10"><tr><td bgcolor="#FFEEEE"><b>Вы — Пёс-Матрос '.$titles[$answer].'</b></td><td bgcolor="#000000" rowspan="2"><img src="http://yetinews.com/tools/pes/'.$images[$answer].'" alt="'.$titles[$answer].'"/></td></tr><tr><td bgcolor="#FFEEEE" valign="top"><small>'.$descriptions[$answer].'</small></td></tr></table><small>Пройти тест <a href="http://yetinews.com/tools/pes/">«Какой вы Пёс-Матрос?»</a></small>
		';
